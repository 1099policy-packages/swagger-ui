...
from .utils import SWAGGER_UI_PY_ROOT, load_config
...
class ApplicationDocument(object):
    def __init__(
        ...
        **extra_config,
        ...
        assert (
            self.config or self.config_url or self.config_path or self.config_spec
    ...
    def get_config(self, host):
        if self.config:
            ...
            config = load_config(self.config_spec)
